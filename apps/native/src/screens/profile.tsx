/**
 * 프로필 탭(네이티브) — 내 정보 요약, 복무율, 공유 그룹.
 *
 * 카드는 셋뿐이다. 예전에는 여기에 사용자 이름·위젯·개인정보와 계정까지 여섯
 * 장이 있었고, 복무율을 보러 들어온 사람이 계정 삭제 버튼까지 지나쳐 스크롤해야
 * 했다. 값을 **바꾸는** 일은 전부 "내 정보 수정"이 여는 화면으로 옮겼다
 * (`screens/profile-edit.tsx`).
 *
 * 넓은 창에서는 두 열로 나눈다 — 세 장이라 한 열에 쌓아도 짧지만, 태블릿에서
