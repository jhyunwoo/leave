 ...
 */
const MonthScrollImpl = forwardRef<CalendarScrollHandle, MonthScrollProps>(
  function MonthScroll({ renderMonth, topContent }, ref) {
    ...
    return (
      <div
        className={`cal-scroll-shell${pageScroll ? " is-page-scroll" : ""}${topContent ? " has-top-content" : ""}`}
      >
        {topContent ? <div className="cal-scroll-top">{topContent}</div> : null}
        <div
...
export const MonthScroll = memo(MonthScrollImpl);
...
>(function CalendarScroll(props, ref) {
  ...
  return <MonthScroll ref={ref} renderMonth={renderMonth} />;
});
